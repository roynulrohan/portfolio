...
const images = [
    {
        original: require('../assets/screenshots/amigo-chat/home.png'),
        thumbnail: require('../assets/screenshots/amigo-chat/home.png'),
    },
    {
        original: require('../assets/screenshots/amigo-chat/conversation.png'),
        thumbnail: require('../assets/screenshots/amigo-chat/conversation.png'),
    },
    {
        original: require('../assets/screenshots/amigo-chat/new-contact.png'),
        thumbnail: require('../assets/screenshots/amigo-chat/new-contact.png'),
    },
    {
        original: require('../assets/screenshots/amigo-chat/login.png'),
        thumbnail: require('../assets/screenshots/amigo-chat/login.png'),
    },
];
            ...
            <ScrollToTop>
                <TabStyleView className='mt-36' redirect={true}>
                    <div className='p-5 px-8'>
                        <h1 className='text-4xl font-semibold mb-2 font-mono text-center'>Amigo Chat</h1>
                        ...
                        <div className='flex flex-wrap justify-center sm:justify-start pt-2'>
                            <p className='text-md'>
                                ...
                                <br />
                                <br />
                                The front-end is a single page React application that utilizes Redux for state management. The back-end is a REST API that
                                ...
                                established via sockets. Application is deployed to Heroku.
                            </p>
                            <div className='mt-10'>
                                <div className='mt-3'>
                                    <div className='flex space-x-3 items-center'>
                                        <h5 className='w-fit leading-tight rounded-lg font-medium text-pink-600'>Front-End:</h5>
                                        <h5 className=''>React, Redux, Bootstrap, SASS</h5>
                                    </div>
                                    <div className='flex space-x-3 items-center mt-3'>
                                        ...
                                        <h5 className=''>Node.js, Express.js, Mongoose, Socket.io</h5>
                                    </div>
                                    <div className='flex space-x-3 items-center mt-3'>
                        ...
                        <div class='flex flex-col items-center space-y-4 mt-14'>
                            ...
                            <div class='flex space-x-3'>
                                <a
                                    href='https://github.com/roynulrohan/amigo-chat'
                                    rel='noreferrer'
                                    target='_blank'
                                ...
                                <a
                                    href='https://amigo-chat.herokuapp.com/'
                                    rel='noreferrer'
                                    target='_blank'
