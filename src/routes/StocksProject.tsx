...
import homePageImg from '../assets/screenshots/stocks-io/Home-Page.png';
...
const images = [
    {
        original: homePageImg,
        thumbnail: homePageImg,
    },
    {
        original: marketPageImg,
        thumbnail: marketPageImg,
    },
    {
        original: stockPageImg,
        thumbnail: stockPageImg,
    },
    {
        original: accountPageImg,
        thumbnail: accountPageImg,
    },
];
                    ...
                    <div className='p-5 px-8'>
                        ...
                        <div className='flex flex-wrap justify-center sm:justify-start pt-2'>
                            <p className='text-md'>
                                ...
                                authentication. Client and API are dockerized and hosted on a personal Ubuntu server.
                            </p>
                            <div className='mt-10'>
                                <div className='mt-3'>
                                    <div className='flex space-x-3 items-center'>
                                        <h5 className='w-fit leading-tight rounded-lg font-medium text-pink-600'>Front-End:</h5>
                                        <h5 className=''>Vite React, Redux, TypeScript, TailwindCSS, SASS, Framer-Motion, Apollo GraphQL, ChartJS</h5>
                                    </div>
                                    <div className='flex space-x-3 items-center mt-3'>
                                        ...
                                        <h5 className=''>Apollo GraphQL, TypeScript, Node.js, Express.js, Socket.io, Mongoose, JWT</h5>
                                    </div>
                                    <div className='flex space-x-3 items-center mt-3'>
                        ...
                        <div className='flex flex-col items-center space-y-4 mt-14'>
                            ...
                            <div className='flex space-x-3'>
                                <a
                                    ...
                                    rel='noreferrer'
                                    target='_blank'
                                    className='flex items-center p-2 px-4 bg-gray-700 hover:bg-gray-800 rounded-lg text-white'>
                                ...
                                <a
                                    href='https://stocks-io.roynul.com/'
                                    rel='noreferrer'
                                    target='_blank'
